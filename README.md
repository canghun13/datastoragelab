...
The published inventory has 101 public pages: 56 tools, 15 guides, eight references, four comparisons, 13 hubs, and five foundational pages. It covers storage needs, NAS configuration, backup planning, network performance, lifecycle cost, power protection, SSD endurance, field media offload, external storage connection planning, developer build storage, and PostgreSQL maintenance storage.
...
`tools/content-qa.mjs` enforces the 101-page inventory, the 56 tool and 13
